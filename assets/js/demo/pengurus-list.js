...
var handleDataTableCombinationSetting = function() {
	...
	if ($('#data-table-combine-1').length !== 0) {
		...
		$('#data-table-combine-1').DataTable(options);

	}

	if ($('#data-table-combine-2').length !== 0) {
...
var handleMenuMarker = function() {
	...
	document.getElementById("list-pengurus").className = 'active';
