 <!-- begin #content -->
    <div id="content" class="content">
      ...
      <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">Add Personel</li>
      </ol>
      <!-- end breadcrumb -->
      <!-- begin page-header -->
        ...
        <div class="col-xl-8">
          <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
              <h4 class="panel-title">Add Personel</h4>
            ...
            <div class="panel-body">
                ...
                <div class="form-group row m-b-15">
                  ...
                  <div class="col-md-8 col-sm-8">
                    <input class="form-control" id="id" name="id" type="number" min="510000" max="999999" data-parsley-required="true" placeholder="ID Number">
                  </div>
                </div>
                <div class="form-group row m-b-15">
                  <label class="col-md-4 col-sm-4 col-form-label" for="email">Name * :</label>
                  <div class="col-md-8 col-sm-8">
                     <input id="name" name="name" type="text" class="form-control" data-parsley-required="true" placeholder="Full Name">
                  </div>
                </div>
                <div class="form-group row m-b-15">
                  <label class="col-md-4 col-sm-4 col-form-label" for="website">Present Title :</label>
                  <div class="col-md-8 col-sm-8">
                     <select id="title" name="title" class="form-control" data-parsley-required="true">
                ...
                <div class="form-group row m-b-15">
                  ...
                  <div class="col-md-8 col-sm-8">
                    <input id="email" name="email" type="email" class="form-control" placeholder="Email Address" data-parsley-email>
                  </div>
                </div>
                 <div class="form-group row m-b-15">
                  <label class="col-md-4 col-sm-4 col-form-label" for="message">AMEL Number :</label>
                  <div class="col-md-8 col-sm-8">
                   <input id="amel" name="amel" type="number" class="form-control" min="1000" max="99999" placeholder="AMEL Number">
                  </div>
                </div>
                <div class="form-group row m-b-15">
                  <label class="col-md-4 col-sm-4 col-form-label" for="message">CS Number :</label>
                  <div class="col-md-8 col-sm-8">
                    <input id="cs" name="cs" type="number" class="form-control" min="10000" max="99999"  data-parsley-range="[10000,99999]" placeholder="Certifying Staff Number">
                  </div>
                </div>
                <div class="form-group row m-b-15">
                  <label class="col-md-4 col-sm-4 col-form-label" for="message">GA Number :</label>
                  <div class="col-md-8 col-sm-8">
                     <input id="ga" name="ga" type="number" class="form-control"  min="1000" max="9999" placeholder="GA Auth. Number">
                  </div>
                </div>
                <div class="form-group row m-b-15">
                  <label class="col-md-4 col-sm-4 col-form-label" for="message">Validity :</label>
                  <div class="col-md-8 col-sm-8">
                    <input type="text" class="form-control" id="datepicker-default"  name="validity" placeholder="Select Date" >
                  </div>
                </div>
                <div class="form-group row m-b-15">
                  <label class="col-md-4 col-sm-4 col-form-label" for="message">Status :</label>
                  <div class="col-md-8 col-sm-8">
                    <select id="status" name="status" class="form-control">Please Select<?php if ($record['status'] ==1){echo 'Active';} else { echo 'Inactive';}?></option>
