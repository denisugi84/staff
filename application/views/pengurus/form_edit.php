        ...
        <div class="col-xl-6">
          <div class="panel panel-primary">
            ...
            <div class="panel-heading">
              <h4 class="panel-title">Edit Units</h4>
       ...
       <!-- begin panel-body -->
            <div class="panel-body">
                            ...
                            $attribute = array ('class'=>'form-horizontal', 'data-parsley-validate'=>'true','autocomplete'=>'off');
                             echo form_open('units/edit'); ?>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-2 col-sm-2 col-form-label" for="inputId">ID UNIT * :</label>
                                    <div class="col-md-10 col-sm-10">
                                        <input class="form-control" type="text" id="inputId" name="inputId"  readonly value="<?php echo $record['ID_UNIT']?>"/>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-10 col-sm-10">
                                        <input class="form-control" type="text" id="inputDinas" name="inputDinas" placeholder="Required" data-parsley-required="true" value="<?php echo $record['DINAS']?>" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-10 col-sm-10">
                                        <input class="form-control" type="text" id="inputUnit" name="inputUnit" placeholder="Unit" value="<?php echo $record['UNIT']?>"/>
                                    </div>
                                </div>
