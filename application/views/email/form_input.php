        ...
        <div class="col-xl-6">
          <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
              <h4 class="panel-title">Add Email</h4>
       ...
       <!-- begin panel-body -->
            <div class="panel-body">
                            ...
                            $attribute = array ('class'=>'form-horizontal', 'data-parsley-validate'=>'true','autocomplete'=>'off');
                             echo form_open('email/post'); ?>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-2 col-sm-2 col-form-label" for="fullname">fullname * :</label>
                                    <div class="col-md-10 col-sm-10">
                                        
                                        <input class="form-control" type="text" id="nama" name="nama" placeholder="Required" data-parsley-required="true"  />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-10 col-sm-10">
                                        <input class="form-control" type="text" id="address" name="address" placeholder="Required" data-parsley-required="true"/>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
