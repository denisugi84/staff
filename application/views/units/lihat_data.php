 <!-- begin #content -->
    <div id="content" class="content">
      ...
      <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item"><a href="units">Unit</a></li>
        ...
        <div class="col-xl-12">
          <div class="panel panel-primary">
            ...
            <div class="panel-heading">
              <h4 class="panel-title">Units List</h4>
            ...
            <div class="panel-body">
                    <a href="<?php echo base_url() ?>units/post" class="btn btn-success pull-right">Add New</a>
                    <table id="data-table-combine" class="table table-striped table-bordered table-td-valign-middle">
                        ...
                        <tr id="<?php echo $r->ID_UNIT?>">
                            <td align="center" width="100"><?php echo $r->ID_UNIT ?></td>
  ...
  <script src="<?php echo base_url();?>assets/js/demo/unit-list.js"></script>